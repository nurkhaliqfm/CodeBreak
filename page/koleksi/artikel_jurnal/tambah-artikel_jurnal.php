        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST">
                    ...
                    <div class="form-group">
                        <label>Jurnal</label>
                        <input class="form-control" name ="jurnal"/>
                    </div>
...
if (isset($_POST['simpan'])){
    ...
    $sql = "INSERT INTO artikel_jurnal (judul, pengarang, penerbit, jurnal, tahun_terbit, isbn, lokasi, tgl_input) 
    VALUE ('$judul', '$pengarang', '$penerbit', '$jurnal', '$tahun_terbit', '$isbn', '$lokasi', '$tgl_input')";
